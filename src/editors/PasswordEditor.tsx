  ...
  ">
    <form className="flex flex-col gap-4" autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-2">
        ...
        <input type="text" className={styling.input.formInput} autoCapitalize="none" autoComplete="off" spellCheck="false" {...register('username')} />
        <label htmlFor="password" className="block">Password</label>
        <input type="text" className={styling.input.formInput} autoCapitalize="none" autoComplete="off" spellCheck="false" {...register('password')} />
      </div>
